...
namespace QuanLyCuaHangTapHoa.Controllers
{
    public class GiohangController : Controller
    {
        ...
        public ActionResult DatHang()
        {
            ...
            {
                return RedirectToAction("Indexadminsp", "Product"); // Redirect if cart is empty
            }
            // Lấy giỏ hàng từ session
            List<Giohang> listGiohang = Laygiohang();
            ViewBag.TongSoLuong = TongSoLuong();
        ...
        public ActionResult DatHang2(int id)
        {
            ...
            _db.SaveChanges();
            Session["Giohang"] = null; // Clear the shopping cart session
            return RedirectToAction("Xacnhandonhang", "Giohang"); // Redirect to order confirmation page
        }
